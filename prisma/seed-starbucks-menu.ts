...
async function main() {
  ...
  const espressoBeverages = await prisma.menuCategory.upsert({
  ...
  const brewedCoffee = await prisma.menuCategory.upsert({
  ...
  const blendedBeverages = await prisma.menuCategory.upsert({
  ...
  const others = await prisma.menuCategory.upsert({
    where: { id: 'others' },
    update: {},
    create: {
      id: 'others',
  ...
  // Food Subcategories
  const coreMenu = await prisma.menuCategory.upsert({
    where: { id: 'core-menu' },
    update: {},
    create: {
      id: 'core-menu',
  ...
  const reserveMenu = await prisma.menuCategory.upsert({
  ...
  const merchandise = await prisma.menuCategory.upsert({
  ...
  const bulkOrder = await prisma.menuCategory.upsert({
    where: { id: 'bulk-order' },
    update: {},
    create: {
      id: 'bulk-order',
